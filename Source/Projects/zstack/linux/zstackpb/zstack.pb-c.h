...
PROTOBUF_C_BEGIN_DECLS typedef struct _AFAddr AFAddr;
...
size_t afaddr__pack_to_buffer
	(const AFAddr * message, ProtobufCBuffer * buffer);
...
size_t simple_descriptor__pack
	(const SimpleDescriptor * message, uint8_t * out);
...
void bind_rec__free_unpacked
	(BindRec * message, ProtobufCAllocator * allocator);
...
void rtg_item__free_unpacked
	(RtgItem * message, ProtobufCAllocator * allocator);
/* BindItem methods */
...
size_t aps_find_group_req__pack
	(const ApsFindGroupReq * message, uint8_t * out);
...
size_t aps_find_group_rsp__pack
	(const ApsFindGroupRsp * message, uint8_t * out);
...
size_t af_un_register_req__pack
	(const AfUnRegisterReq * message, uint8_t * out);
...
size_t zdo_power_desc_req__pack
	(const ZdoPowerDescReq * message, uint8_t * out);
...
size_t zdo_match_desc_req__pack
	(const ZdoMatchDescReq * message, uint8_t * out);
...
size_t zdo_mgmt_leave_req__pack
	(const ZdoMgmtLeaveReq * message, uint8_t * out);
...
size_t zdo_unbind_rsp_ind__pack
	(const ZdoUnbindRspInd * message, uint8_t * out);
...
size_t sec_aps_remove_req__pack
	(const SecApsRemoveReq * message, uint8_t * out);
...
typedef void (*AFAddr_Closure) (const AFAddr * message, void *closure_data);
typedef void (*StartupOptions_Closure)
	(const StartupOptions * message, void *closure_data);
typedef void (*SimpleDescriptor_Closure)
	(const SimpleDescriptor * message, void *closure_data);
typedef void (*TransOptions_Closure)
	(const TransOptions * message, void *closure_data);
typedef void (*CapabilityInfo_Closure)
	(const CapabilityInfo * message, void *closure_data);
typedef void (*ServerCapabilities_Closure)
	(const ServerCapabilities * message, void *closure_data);
typedef void (*BindRec_Closure) (const BindRec * message, void *closure_data);
typedef void (*LeaveOptions_Closure)
	(const LeaveOptions * message, void *closure_data);
typedef void (*NodeDescriptor_Closure)
	(const NodeDescriptor * message, void *closure_data);
typedef void (*PowerSource_Closure)
	(const PowerSource * message, void *closure_data);
typedef void (*PowerDescriptor_Closure)
	(const PowerDescriptor * message, void *closure_data);
typedef void (*NwkDiscItem_Closure)
	(const NwkDiscItem * message, void *closure_data);
typedef void (*NeighborLqiItem_Closure)
	(const NeighborLqiItem * message, void *closure_data);
typedef void (*RtgItem_Closure) (const RtgItem * message, void *closure_data);
typedef void (*BindItem_Closure) (const BindItem * message, void *closure_data);
typedef void (*DeviceTypes_Closure)
	(const DeviceTypes * message, void *closure_data);
typedef void (*SysResetReq_Closure)
	(const SysResetReq * message, void *closure_data);
typedef void (*SysVersionReq_Closure)
	(const SysVersionReq * message, void *closure_data);
typedef void (*SysConfigReadReq_Closure)
	(const SysConfigReadReq * message, void *closure_data);
typedef void (*SysConfigWriteReq_Closure)
	(const SysConfigWriteReq * message, void *closure_data);
typedef void (*SysSetTxPowerReq_Closure)
	(const SysSetTxPowerReq * message, void *closure_data);
typedef void (*SysNwkInfoReadReq_Closure)
	(const SysNwkInfoReadReq * message, void *closure_data);
typedef void (*SysResetInd_Closure)
	(const SysResetInd * message, void *closure_data);
typedef void (*SysVersionRsp_Closure)
	(const SysVersionRsp * message, void *closure_data);
typedef void (*SysConfigReadRsp_Closure)
	(const SysConfigReadRsp * message, void *closure_data);
typedef void (*SysSetTxPowerRsp_Closure)
	(const SysSetTxPowerRsp * message, void *closure_data);
typedef void (*SysNwkInfoReadRsp_Closure)
	(const SysNwkInfoReadRsp * message, void *closure_data);
typedef void (*DevStartReq_Closure)
	(const DevStartReq * message, void *closure_data);
typedef void (*DevNwkDiscReq_Closure)
	(const DevNwkDiscReq * message, void *closure_data);
typedef void (*DevJoinReq_Closure)
	(const DevJoinReq * message, void *closure_data);
typedef void (*DevRejoinReq_Closure)
	(const DevRejoinReq * message, void *closure_data);
typedef void (*DevZDOCBReq_Closure)
	(const DevZDOCBReq * message, void *closure_data);
typedef void (*DevNwkRouteReq_Closure)
	(const DevNwkRouteReq * message, void *closure_data);
typedef void (*DevNwkCheckRouteReq_Closure)
	(const DevNwkCheckRouteReq * message, void *closure_data);
typedef void (*DevJammerInd_Closure)
	(const DevJammerInd * message, void *closure_data);
typedef void (*DevPermitJoinInd_Closure)
	(const DevPermitJoinInd * message, void *closure_data);
typedef void (*ApsRemoveGroup_Closure)
	(const ApsRemoveGroup * message, void *closure_data);
typedef void (*ApsRemoveAllGroups_Closure)
	(const ApsRemoveAllGroups * message, void *closure_data);
typedef void (*ApsFindAllGroupsReq_Closure)
	(const ApsFindAllGroupsReq * message, void *closure_data);
typedef void (*ApsFindAllGroupsRsp_Closure)
	(const ApsFindAllGroupsRsp * message, void *closure_data);
typedef void (*ApsFindGroupReq_Closure)
	(const ApsFindGroupReq * message, void *closure_data);
typedef void (*ApsFindGroupRsp_Closure)
	(const ApsFindGroupRsp * message, void *closure_data);
typedef void (*ApsAddGroup_Closure)
	(const ApsAddGroup * message, void *closure_data);
typedef void (*ApsCountAllGroups_Closure)
	(const ApsCountAllGroups * message, void *closure_data);
typedef void (*AfRegisterReq_Closure)
	(const AfRegisterReq * message, void *closure_data);
typedef void (*AfUnRegisterReq_Closure)
	(const AfUnRegisterReq * message, void *closure_data);
typedef void (*AfDataReq_Closure)
	(const AfDataReq * message, void *closure_data);
typedef void (*AfInterPanCtlReq_Closure)
	(const AfInterPanCtlReq * message, void *closure_data);
typedef void (*AfConfigGetReq_Closure)
	(const AfConfigGetReq * message, void *closure_data);
typedef void (*AfConfigSetReq_Closure)
	(const AfConfigSetReq * message, void *closure_data);
typedef void (*AfConfigGetRsp_Closure)
	(const AfConfigGetRsp * message, void *closure_data);
typedef void (*AfDataConfirmInd_Closure)
	(const AfDataConfirmInd * message, void *closure_data);
typedef void (*AfIncomingMsgInd_Closure)
	(const AfIncomingMsgInd * message, void *closure_data);
typedef void (*AfReflectErrorInd_Closure)
	(const AfReflectErrorInd * message, void *closure_data);
typedef void (*ZdoNwkAddrReq_Closure)
	(const ZdoNwkAddrReq * message, void *closure_data);
typedef void (*ZdoIeeeAddrReq_Closure)
	(const ZdoIeeeAddrReq * message, void *closure_data);
typedef void (*ZdoNodeDescReq_Closure)
	(const ZdoNodeDescReq * message, void *closure_data);
typedef void (*ZdoPowerDescReq_Closure)
	(const ZdoPowerDescReq * message, void *closure_data);
typedef void (*ZdoSimpleDescReq_Closure)
	(const ZdoSimpleDescReq * message, void *closure_data);
typedef void (*ZdoActiveEndpointReq_Closure)
	(const ZdoActiveEndpointReq * message, void *closure_data);
typedef void (*ZdoMatchDescReq_Closure)
	(const ZdoMatchDescReq * message, void *closure_data);
typedef void (*ZdoComplexDescReq_Closure)
	(const ZdoComplexDescReq * message, void *closure_data);
typedef void (*ZdoUserDescReq_Closure)
	(const ZdoUserDescReq * message, void *closure_data);
typedef void (*ZdoDeviceAnnounceReq_Closure)
	(const ZdoDeviceAnnounceReq * message, void *closure_data);
typedef void (*ZdoUserDescSetReq_Closure)
	(const ZdoUserDescSetReq * message, void *closure_data);
typedef void (*ZdoServerDiscReq_Closure)
	(const ZdoServerDiscReq * message, void *closure_data);
typedef void (*ZdoEndDeviceBindReq_Closure)
	(const ZdoEndDeviceBindReq * message, void *closure_data);
typedef void (*ZdoBindReq_Closure)
	(const ZdoBindReq * message, void *closure_data);
typedef void (*ZdoUnbindReq_Closure)
	(const ZdoUnbindReq * message, void *closure_data);
typedef void (*ZdoMgmtNwkDiscReq_Closure)
	(const ZdoMgmtNwkDiscReq * message, void *closure_data);
typedef void (*ZdoMgmtLqiReq_Closure)
	(const ZdoMgmtLqiReq * message, void *closure_data);
typedef void (*ZdoMgmtRtgReq_Closure)
	(const ZdoMgmtRtgReq * message, void *closure_data);
typedef void (*ZdoMgmtBindReq_Closure)
	(const ZdoMgmtBindReq * message, void *closure_data);
typedef void (*ZdoMgmtLeaveReq_Closure)
	(const ZdoMgmtLeaveReq * message, void *closure_data);
typedef void (*ZdoMgmtDirectJoinReq_Closure)
	(const ZdoMgmtDirectJoinReq * message, void *closure_data);
typedef void (*ZdoMgmtPermitJoinReq_Closure)
	(const ZdoMgmtPermitJoinReq * message, void *closure_data);
typedef void (*ZdoMgmtNwkUpdateReq_Closure)
	(const ZdoMgmtNwkUpdateReq * message, void *closure_data);
typedef void (*ZdoNwkAddrRspInd_Closure)
	(const ZdoNwkAddrRspInd * message, void *closure_data);
typedef void (*ZdoIeeeAddrRspInd_Closure)
	(const ZdoIeeeAddrRspInd * message, void *closure_data);
typedef void (*ZdoNodeDescRspInd_Closure)
	(const ZdoNodeDescRspInd * message, void *closure_data);
typedef void (*ZdoPowerDescRspInd_Closure)
	(const ZdoPowerDescRspInd * message, void *closure_data);
typedef void (*ZdoSimpleDescRspInd_Closure)
	(const ZdoSimpleDescRspInd * message, void *closure_data);
typedef void (*ZdoActiveEndpointsRspInd_Closure)
	(const ZdoActiveEndpointsRspInd * message, void *closure_data);
typedef void (*ZdoMatchDescRspInd_Closure)
	(const ZdoMatchDescRspInd * message, void *closure_data);
typedef void (*ZdoUserDescRspInd_Closure)
	(const ZdoUserDescRspInd * message, void *closure_data);
typedef void (*ZdoServerDiscoveryRspInd_Closure)
	(const ZdoServerDiscoveryRspInd * message, void *closure_data);
typedef void (*ZdoEndDeviceTimeoutRspInd_Closure)
	(const ZdoEndDeviceTimeoutRspInd * message, void *closure_data);
typedef void (*ZdoBindRspInd_Closure)
	(const ZdoBindRspInd * message, void *closure_data);
typedef void (*ZdoEndDeviceBindRspInd_Closure)
	(const ZdoEndDeviceBindRspInd * message, void *closure_data);
typedef void (*ZdoUnbindRspInd_Closure)
	(const ZdoUnbindRspInd * message, void *closure_data);
typedef void (*ZdoDeviceAnnounceInd_Closure)
	(const ZdoDeviceAnnounceInd * message, void *closure_data);
typedef void (*ZdoMgmtNwkDiscRspInd_Closure)
	(const ZdoMgmtNwkDiscRspInd * message, void *closure_data);
typedef void (*ZdoMgmtLqiRspInd_Closure)
	(const ZdoMgmtLqiRspInd * message, void *closure_data);
typedef void (*ZdoMgmtRtgRspInd_Closure)
	(const ZdoMgmtRtgRspInd * message, void *closure_data);
typedef void (*ZdoMgmtBindRspInd_Closure)
	(const ZdoMgmtBindRspInd * message, void *closure_data);
typedef void (*ZdoMgmtLeaveRspInd_Closure)
	(const ZdoMgmtLeaveRspInd * message, void *closure_data);
typedef void (*ZdoMgmtDirectJoinRspInd_Closure)
	(const ZdoMgmtDirectJoinRspInd * message, void *closure_data);
typedef void (*ZdoMgmtPermitJoinRspInd_Closure)
	(const ZdoMgmtPermitJoinRspInd * message, void *closure_data);
typedef void (*ZdoMgmtNwkUpdateNotifyInd_Closure)
	(const ZdoMgmtNwkUpdateNotifyInd * message, void *closure_data);
typedef void (*ZdoTcDeviceInd_Closure)
	(const ZdoTcDeviceInd * message, void *closure_data);
typedef void (*ZdoSrcRtgInd_Closure)
	(const ZdoSrcRtgInd * message, void *closure_data);
typedef void (*ZdoConcentratorInd_Closure)
	(const ZdoConcentratorInd * message, void *closure_data);
typedef void (*ZdoNwkDiscCnf_Closure)
	(const ZdoNwkDiscCnf * message, void *closure_data);
typedef void (*ZdoBeaconNotifyInd_Closure)
	(const ZdoBeaconNotifyInd * message, void *closure_data);
typedef void (*ZdoJoinCnf_Closure)
	(const ZdoJoinCnf * message, void *closure_data);
typedef void (*ZdoLeaveCnf_Closure)
	(const ZdoLeaveCnf * message, void *closure_data);
typedef void (*ZdoLeaveInd_Closure)
	(const ZdoLeaveInd * message, void *closure_data);
typedef void (*DevStateChangeInd_Closure)
	(const DevStateChangeInd * message, void *closure_data);
typedef void (*SecNwkKeyGetReq_Closure)
	(const SecNwkKeyGetReq * message, void *closure_data);
typedef void (*SecNwkKeySetReq_Closure)
	(const SecNwkKeySetReq * message, void *closure_data);
typedef void (*SecNwkKeyUpdateReq_Closure)
	(const SecNwkKeyUpdateReq * message, void *closure_data);
typedef void (*SecNwkKeySwitchReq_Closure)
	(const SecNwkKeySwitchReq * message, void *closure_data);
typedef void (*SecApsLinkKeyGetReq_Closure)
	(const SecApsLinkKeyGetReq * message, void *closure_data);
typedef void (*SecApsLinkKeySetReq_Closure)
	(const SecApsLinkKeySetReq * message, void *closure_data);
typedef void (*SecApsLinkKeyRemoveReq_Closure)
	(const SecApsLinkKeyRemoveReq * message, void *closure_data);
typedef void (*SecApsRemoveReq_Closure)
	(const SecApsRemoveReq * message, void *closure_data);
typedef void (*SecNwkKeyGetRsp_Closure)
	(const SecNwkKeyGetRsp * message, void *closure_data);
typedef void (*SecApsLinkKeyGetRsp_Closure)
	(const SecApsLinkKeyGetRsp * message, void *closure_data);
typedef void (*ZstackDefaultRsp_Closure)
	(const ZstackDefaultRsp * message, void *closure_data);
