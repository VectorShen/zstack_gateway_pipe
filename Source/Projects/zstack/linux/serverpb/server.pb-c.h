...
size_t srvr_device_info_t__pack
	(const SrvrDeviceInfoT * message, uint8_t * out);
...
typedef void (*SrvrSimpleDescriptorT_Closure)
	(const SrvrSimpleDescriptorT * message, void *closure_data);
typedef void (*SrvrDeviceInfoT_Closure)
	(const SrvrDeviceInfoT * message, void *closure_data);
typedef void (*SrvrGetIeeeAddressReq_Closure)
	(const SrvrGetIeeeAddressReq * message, void *closure_data);
typedef void (*SrvrGetIeeeAddressCnf_Closure)
	(const SrvrGetIeeeAddressCnf * message, void *closure_data);
typedef void (*SrvrGetShortAddressReq_Closure)
	(const SrvrGetShortAddressReq * message, void *closure_data);
typedef void (*SrvrGetShortAddressCnf_Closure)
	(const SrvrGetShortAddressCnf * message, void *closure_data);
typedef void (*SrvrGetDeviceInfoReq_Closure)
	(const SrvrGetDeviceInfoReq * message, void *closure_data);
typedef void (*SrvrGetDeviceInfoCnf_Closure)
	(const SrvrGetDeviceInfoCnf * message, void *closure_data);
typedef void (*SrvrGetDeviceStatusReq_Closure)
	(const SrvrGetDeviceStatusReq * message, void *closure_data);
typedef void (*SrvrGetDeviceStatusCnf_Closure)
	(const SrvrGetDeviceStatusCnf * message, void *closure_data);
typedef void (*SrvrSetDeviceStatusReq_Closure)
	(const SrvrSetDeviceStatusReq * message, void *closure_data);
typedef void (*SrvrSetDeviceStatusCnf_Closure)
	(const SrvrSetDeviceStatusCnf * message, void *closure_data);
