...
#if 0
extern ZStatus_t zclOTA_SendReadImageStatus (afAddrType_t * dstAddr,
                                                void *pParams, uint8 zclSeqNo);
#endif
...
extern ZStatus_t zclOTA_SendQueryNextImageReq (afAddrType_t * dstAddr,
                                                zclOTA_QueryNextImageReqParams_t
                                                * pParams, uint8 zclSeqNo);
extern ZStatus_t zclOTA_SendImageBlockReq (afAddrType_t * dstAddr,
                                            zclOTA_ImageBlockReqParams_t *
                                            pParams, uint8 zclSeqNo);
extern ZStatus_t zclOTA_SendUpgradeEndReq (afAddrType_t * dstAddr,
                                            zclOTA_UpgradeEndReqParams_t *
                                            pParams, uint8 zclSeqNo);
...
#if (defined OTA_SERVER) && (OTA_SERVER == TRUE)
extern ZStatus_t zclOTA_SendQueryNextImageRsp (afAddrType_t * dstAddr,
                                                zclOTA_QueryImageRspParams_t
                                                * pParams, uint8 zclSeqNo);
extern ZStatus_t zclOTA_SendImageBlockRsp (afAddrType_t * dstAddr,
                                            zclOTA_ImageBlockRspParams_t *
                                            pParams, uint8 zclSeqNo);
extern ZStatus_t zclOTA_SendUpgradeEndRsp (afAddrType_t * dstAddr,
                                            zclOTA_UpgradeEndRspParams_t *
                                            pParams, uint8 zclSeqNo);
