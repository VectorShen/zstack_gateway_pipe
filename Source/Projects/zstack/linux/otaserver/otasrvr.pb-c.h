...
PROTOBUF_C_BEGIN_DECLS typedef struct _AddressStruct AddressStruct;
...
typedef void (*AddressStruct_Closure)
	(const AddressStruct * message, void *closure_data);
typedef void (*OtaZigbeeGenericCnf_Closure)
	(const OtaZigbeeGenericCnf * message, void *closure_data);
typedef void (*OtaZigbeeGenericRspInd_Closure)
	(const OtaZigbeeGenericRspInd * message, void *closure_data);
typedef void (*OtaUpdateImageRegisterationReq_Closure)
	(const OtaUpdateImageRegisterationReq * message, void *closure_data);
typedef void (*OtaUpdateEnableReq_Closure)
	(const OtaUpdateEnableReq * message, void *closure_data);
typedef void (*OtaUpdateEnableCnf_Closure)
	(const OtaUpdateEnableCnf * message, void *closure_data);
typedef void (*OtaUpdateDlFinishedInd_Closure)
	(const OtaUpdateDlFinishedInd * message, void *closure_data);
typedef void (*OtaUpdateApplyImageReq_Closure)
	(const OtaUpdateApplyImageReq * message, void *closure_data);
