...
/*
    ...
    *
    */
extern epList_t *afRegisterExtended (endPointDesc_t * epDesc,
                                        pDescCB descFn);
...
afStatus_t AF_DataRequestSrcRtg (afAddrType_t * dstAddr,
                                    endPointDesc_t * srcEP, uint16 cID,
...
/*
    ...
    */
extern uint8 afFindSimpleDesc (SimpleDescriptionFormat_t ** ppDesc,
                                uint8 EP);
